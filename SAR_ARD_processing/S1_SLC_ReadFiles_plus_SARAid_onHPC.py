# This program extracts a list of all Sentinel-1 GRD files for the specified lat/lon extent and dates defined in 'TestURL' from the Sentinel-1 Australasia Regional Access data hub (https://copernicus.nci.org.au/sara.client/#/home ). 
# The product type of SLC is defined in 'TestURL'.
...
TestURL = "https://copernicus.nci.org.au/sara.server/1.0/api/collections/S1/search.json?_pretty=1" \
          "&startDate=2019-06-20&completionDate=2019-08-20&productType=SLC&sensorMode=IW" \
          "&geometry=POLYGON((131.02 -16.36, 132.15 -16.36, 132.15 -16.49, 131.02 -16.49, 131.02 -16.36))"
...
outfile = 'Z:/SAR/S1_filenames_SLC_IW_wSARAid_lateJunTo20Aug2019.txt'
